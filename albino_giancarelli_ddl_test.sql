...
ALTER SCHEMA tptest OWNER TO tf39_dba;
...
ALTER TABLE tptest.compania_electrica OWNER TO tf39_dba;
...
ALTER TABLE tptest.entrega_produccion OWNER TO tf39_dba;
...
ALTER TABLE tptest.entrega_proveeduria OWNER TO tf39_dba;
...
ALTER TABLE tptest.estacion_primaria OWNER TO tf39_dba;
...
ALTER TABLE tptest.linea OWNER TO tf39_dba;
...
ALTER TABLE tptest.productor OWNER TO tf39_dba;
...
ALTER TABLE tptest.productor_hidroelectrico OWNER TO tf39_dba;
...
ALTER TABLE tptest.productor_nuclear OWNER TO tf39_dba;
...
ALTER TABLE tptest.productor_solar OWNER TO tf39_dba;
...
ALTER TABLE tptest.productor_termico OWNER TO tf39_dba;
...
ALTER TABLE tptest.proveedor OWNER TO tf39_dba;
...
ALTER TABLE tptest.provincia OWNER TO tf39_dba;
...
ALTER TABLE tptest.red_distribucion OWNER TO tf39_dba;
...
ALTER TABLE tptest.red_pertenece_compania OWNER TO tf39_dba;
...
ALTER TABLE tptest.subestacion OWNER TO tf39_dba;
...
ALTER TABLE tptest.suministro_inter_red OWNER TO tf39_dba;
...
ALTER TABLE tptest.transportista OWNER TO tf39_dba;
...
ALTER TABLE tptest.zona OWNER TO tf39_dba;
...
--
-- Name: entrega_produccion entrega_produccion_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: entrega_proveeduria entrega_proveeduria_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: estacion_primaria estacion_primaria_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: linea linea_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: productor productor_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: proveedor proveedor_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: provincia provincia_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: red_distribucion red_distribucion_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: subestacion subestacion_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: transportista transportista_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: zona zona_pkey; Type: CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: entrega_produccion entrega_produccion_nombre_estacion_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: entrega_produccion entrega_produccion_nombre_productor_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: entrega_proveeduria entrega_proveeduria_nombre_productor_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: entrega_proveeduria entrega_proveeduria_nombre_proveedor_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: linea linea_numero_red_distribucion_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: productor_hidroelectrico productor_hidroelectrico_nombre_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: productor_nuclear productor_nuclear_nombre_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: productor_solar productor_solar_nombre_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: productor_termico productor_termico_nombre_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: red_distribucion red_distribucion_nombre_estacion_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: red_pertenece_compania red_pertenece_compania_nombre_compania_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: red_pertenece_compania red_pertenece_compania_numero_red_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: subestacion subestacion_linea_id_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: suministro_inter_red suministro_inter_red_suministrado_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: suministro_inter_red suministro_inter_red_suministrador_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: zona zona_id_subestacion_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
...
--
-- Name: zona zona_nombre_provincia_fkey; Type: FK CONSTRAINT; Schema: tptest; Owner: tf39_dba
--
